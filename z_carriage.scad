...
module rail_holders(bearing_dia, bearing_length, Yaxis_seperation)
{
	...
	{
		//main block
		linear_extrude(height=carriage_height/4.5) roundedSquare(pos=[Yaxis_seperation/2.5, front_carriage_depth+bearing_dia/2],r=3);
...
module fillets(Yaxis_seperation, carriage_width, carriage_height)
{
	...
	difference()
	{
		...
		translate([	Yaxis_seperation/(6*2)+carriage_width/2-0.1-3/2, 
					//front_carriage_depth-carriage_width/(1.21*2),
