...
GT2x20_modified = 	  ["GT2a",                        20, 12.22, 12.22 / 2 - 0.75,        7,  16, 8,  10, 16.0, 1.0, 6,    4, [0,     0, -1], 0, M3_grub_screw];
GT2x16_small = 		  ["GT2_small",                   16, 9.68,   9.68 / 2 - 0.75,        7,  13, 7,   5, 13.0, 1.0, 6,    4, [0,     0, -1], 0, M3_grub_screw];
